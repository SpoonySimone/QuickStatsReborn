...
public class ModConfig extends Config {
    ...
    @Button(
            name = "Reset Window",
            text = "Reset",
            description = "Reset the window to the default values for your current HUD scale.\nYou might need to reopen the HUD and\\or restart your game for it to update.",
            category = "HUD Settings", subcategory = "General"
    )
    ...
    @Switch(
            ...
            category = "HUD Settings", subcategory = "Size"
    )
    ...
    @Color(
            ...
            category = "HUD Settings", subcategory = "Colors"
    )
    ...
    @Switch(
            name = "Text Shadow",
            description = "Render the text with a shadow on the HUD.",
            category = "HUD Settings", subcategory = "HUD"
    )
    ...
    @Switch(
            name = "3D Heads",
            description = "Enable 3D heads on the HUD window.",
            category = "HUD Settings", subcategory = "HUD"
    )
    ...
    @Dropdown(
            ...
            category = "HUD Settings", subcategory = "Window",
            options = {"Top Right", "Top Left", "Bottom Right", "Bottom Left"}
    )
    public static int winPreset = 0;
    @Dropdown(
            name = "Animation",
            description = "Type of window animation to use when drawing the HUD.",
            category = "HUD Settings", subcategory = "Window",
    ...
    public ModConfig() {
        super(new Mod("QuickStatsReborn", ModType.HYPIXEL, "/qsr_icon.svg"), "quickstatsreborn.json");
        initialize();
